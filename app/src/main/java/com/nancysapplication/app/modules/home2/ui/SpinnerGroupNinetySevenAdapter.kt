...
class SpinnerGroupNinetySevenAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupNinetySevenModel>
) : ArrayAdapter<SpinnerGroupNinetySevenModel>(mContext, layoutResource, allItems) {
