...
class SpinnerGroupNinetyNineAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerGroupNinetyNineModel>
) : ArrayAdapter<SpinnerGroupNinetyNineModel>(mContext, layoutResource, allItems) {
